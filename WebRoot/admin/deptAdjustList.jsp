		...
		<div class="row">
			...
			<div class="span9">
				...
				<div class="widget widget-table">
					...
					<a href="${pageContext.request.contextPath}/getDeptadjustByPager?pageNo=${prev}" class="btn btn-small">
						<i>上一页</i>
					</a>
					<a href="${pageContext.request.contextPath}/getDeptadjustByPager?pageNo=${next}" class="btn btn-small">
						<i>下一页</i>
					</a>
					</div> --%>
...
<script type="text/javascript">
	function form_submit(pageNo){
			$("#form_table").attr("action","${pageContext.request.contextPath}/getDeptadjustByPager?pageNo="+pageNo);
			$("#form_table").submit();
	}
</script>
